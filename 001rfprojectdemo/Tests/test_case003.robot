...
*** Settings ***
Documentation    Demo for selecting radio buttons and checkboxes in robot framework
Library          SeleniumLibrary

***Variables***

${browser}    Chrome
${ddurl}        https://the-internet.herokuapp.com/dropdown
${cburl}        https://the-internet.herokuapp.com/checkboxes
${rburl}        https://www.seleniumeasy.com/test/basic-radiobutton-demo.html
